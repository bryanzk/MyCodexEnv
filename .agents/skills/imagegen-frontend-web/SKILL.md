...
description: "Use when the user asks to generate website or landing-page reference images, usually one horizontal image per section. This skill is image-direction only; do not use for implementing code, mobile app screens, brand boards, or normal frontend styling."
---
...
Use this skill to create web section reference images. Stop at image direction and do not write implementation code unless the user asks for a separate implementation step. For code from images use `image-to-code`; for mobile app screens use `imagegen-frontend-mobile`; for brand identity boards use `brandkit`.
