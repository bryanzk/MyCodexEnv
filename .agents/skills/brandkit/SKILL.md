---
name: brandkit
description: "Use when the user asks for a brand identity image, brand-guidelines board, logo system, identity deck, or visual-world presentation. Do not use for frontend implementation, website section mockups, generic image generation, or copy-only brand strategy."
---
...
Use this skill for brand-system image outputs: logo boards, identity-system presentations, visual-world boards, and brand-kit mockups. If the user asks to build a website, route to a frontend implementation skill. If the user asks for website section reference images, route to `imagegen-frontend-web`. If the user asks for mobile app screens, route to `imagegen-frontend-mobile`.
