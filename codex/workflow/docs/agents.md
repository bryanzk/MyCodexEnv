...
1. ~/.codex/workflow/memory/today.md — Today's work context
...
|-------|----------|--------|---------|
| **L0 Rules Layer** | ~/.codex/ | Claude only | Rules, memory, experience |
...
4. Never write to ~/.codex/ or knowledge vault (unless task explicitly requires)
...
| External models | Code files | Code + Handoff block | ROADMAP/FOCUS/TODO/TASKS/.codex/vault/ |
