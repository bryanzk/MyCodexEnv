...
**Trigger**: Adding/installing skill files (`~/.codex/skills/`), adding MCP server, or importing third-party skill code
...
**Execution command**:
```bash
~/.codex/workflow/scripts/scan_skill_security.sh <path-to-skill-or-mcp-config>
```
