---
name: review
description: Use when reviewing current-branch changes against main before merge, especially to catch structural bugs around SQL safety, trust boundaries, side effects, and missing tests.
---
...
Read `codex/skills/review/checklist.md` in the repo checkout, or `~/.codex/skills/review/checklist.md` if the skill is synced into the Codex home.
