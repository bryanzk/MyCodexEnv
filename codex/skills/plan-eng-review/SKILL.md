...
description: Use when a user wants engineering-manager-style review of an implementation plan before coding, especially to lock architecture, diagrams, edge cases, tests, and performance tradeoffs.
---
