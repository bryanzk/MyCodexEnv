---
name: browse
description: Use when interactive browser automation is needed for QA, reproduction, visual checks, authenticated flows, or file uploads that search/open tools cannot cover.
---
...
If `NEEDS_SETUP`, build it once:

```bash
cd codex/skills/browse 2>/dev/null || cd ~/.codex/skills/browse
./setup
```
