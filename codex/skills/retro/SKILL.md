---
name: retro
description: Use when a user wants a time-windowed engineering retrospective from git history, including contribution patterns, hotspots, streaks, and team-aware summaries.
---
