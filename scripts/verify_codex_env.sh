...
results+=("$(check codex_retired_router_source_absent '[[ ! -e "'"${REPO_ROOT}"'"/codex/hooks/model_router.py ]]')")
results+=("$(check codex_retired_router_runtime_absent '[[ ! -e "'"${CODEX_HOME}"'"/hooks/model_router.py ]]')")
